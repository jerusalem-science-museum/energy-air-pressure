...
# ==============================================================================
# Jerusalem Science Museum - Exhibit Setup & Launch Script
# Repository: energy-air-pressure
# Standard: JSM-Exhibit-Setup-Wiki Compliance
# ==============================================================================
...
# Standard museum deployment environment checks
if [ -d "venv" ]; then
